...
public sealed class CliOneshotRuntime : ISubAgentRuntime
{
        ...
        CancellationToken cancellationToken)
    {
        return Task.FromResult(new SubAgentSessionHandle(
            RuntimeType,
            profile.Name,
            new CliOneshotSessionState(profile)));
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var invocation = BuildInvocation(profile, request.Task, ref outputFilePath);
            sink.OnProgress(
                "external-cli",
    ...
    private static InvocationPlan BuildInvocation(SubAgentProfile profile, string task, ref string? outputFilePath)
    {
    ...
    private sealed class CliOneshotSessionState(SubAgentProfile profile)
    {
