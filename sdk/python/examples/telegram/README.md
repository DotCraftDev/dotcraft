...
- [SDK README](../../README.md) — `dotcraft_wire` SDK overview and API reference.
- [SDK Architecture](../../ARCHITECTURE.md) — How the SDK works internally.
- [External Channel Adapter Spec](../../../../specs/external-channel-adapter.md) — Wire protocol extension specification.
