...
对于社交渠道，DotCraft 使用 SDK 拓展的方式集成，详见 [Python SDK](https://dotharness.github.io/dotcraft/sdk/python) 和 [TypeScript SDK](https://dotharness.github.io/dotcraft/sdk/typescript)。
