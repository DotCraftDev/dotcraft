...
QQ / 企业微信通过 TypeScript 外部渠道接入，配置详情可查看 [QQ 渠道适配器](https://dotharness.github.io/dotcraft/sdk/typescript-qq) 和 [企业微信渠道适配器](https://dotharness.github.io/dotcraft/sdk/typescript-wecom)。
...
目前集成了 Telegram、微信、飞书、QQ、企业微信社交渠道。
...
- [QQ 渠道适配器](https://dotharness.github.io/dotcraft/sdk/typescript-qq)：NapCat、权限与审批
- [企业微信渠道适配器](https://dotharness.github.io/dotcraft/sdk/typescript-wecom)：企业微信回调、权限审批与投递
