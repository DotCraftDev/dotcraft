...
<table>
<tr>
<td width="33%" align="center"><b>📁 项目级工作空间</b><br/>会话、记忆、技能与配置围绕仓库演进</td>
<td width="33%" align="center"><b>⚡ 统一会话模型</b><br/>同一套 Harness 贯穿 CLI、Desktop、IDE、机器人与自动化</td>
...
| 能力主题 | 这意味着什么 |
|------|------|
| 📁 项目级工作空间 | Agent 可以不受具体应用形态限制真正了解你的项目 |
| ⚡ 统一会话模型 | 跨越社交软件、终端、桌面应用、编辑器和 Agent 对话 |
| 🛡️ 可观测与审批 | Agent 安全可靠，出问题随时定位溯源 |
| 🔗 扩展与集成 | 高度可拓展性，快速集成业务功能 |
...
- **飞书**（TypeScript SDK）：WebSocket 事件订阅、交互式审批卡片，以及与 DotCraft 外部渠道协议的完整接入。详见 [Feishu 包](./sdk/typescript/packages/channel-feishu/README_ZH.md) 与 [TypeScript SDK](./sdk/typescript/README_ZH.md)。
