...
flowchart TB
    ...
    class CliHost,GatewayHost,AcpHost hostStyle
    class QQModule,WeComModule,ApiModule,AcpModule,GitHubModule moduleStyle
...
如果你希望让 DotCraft 自动轮询 GitHub Issue、创建隔离工作区、派发编码 Agent 并在完成后回收任务，请查看 [GitHubTracker 指南](./docs/github_tracker_guide.md)。
...
- [GitHubTracker 指南](./docs/github_tracker_guide.md)：GitHub Issue 轮询、隔离工作区、Agent 派发与完成回收流程
