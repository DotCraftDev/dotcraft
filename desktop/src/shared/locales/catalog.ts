...
const MESSAGES_EN = {
  ...
  'tray.openDesktop': 'Open Desktop',
  'tray.openDashboard': 'Open Dashboard',
  'tray.restartAppServer': 'Restart AppServer',
  'tray.stopAppServer': 'Stop AppServer',
  'tray.recent': 'Recent',
  'tray.noRecentWorkspaces': 'No recent workspaces',
  'tray.appServers': 'AppServers',
  'tray.noManagedAppServers': 'No managed AppServers',
...
const MESSAGES_ZH: Record<MessageId, string> = {
  ...
  'tray.newChat': '新聊天',
  'tray.openDesktop': '打开 Desktop',
  'tray.openDashboard': '打开 Dashboard',
  'tray.restartAppServer': '重启 AppServer',
  'tray.stopAppServer': '停止 AppServer',
  'tray.recent': '最近',
  'tray.noRecentWorkspaces': '暂无最近工作区',
  'tray.appServers': 'AppServers',
  'tray.noManagedAppServers': '暂无受管 AppServer',
  'tray.refresh': '刷新',
  'tray.exit': '退出',
