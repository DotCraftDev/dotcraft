...
const MESSAGES_EN = {
  ...
  'skills.heroTitle': 'Give DotCraft the skills you need',
  'skills.intro':
  ...
  'auto.githubConfig.subtitle': 'Connect a repository and choose the workflow files GitHub automation should use.',
  'auto.githubConfig.restartHintShort': 'Saved settings apply after AppServer restart.',
  'auto.githubConfig.dashboardHintShort': 'Advanced limits, states, and hooks stay in Dashboard.',
  'auto.githubConfig.statusEnabled': 'Enabled',
  'auto.githubConfig.statusDisabled': 'Disabled',
  'auto.githubConfig.connectionTitle': 'Connection',
  'auto.githubConfig.connectionDescription': 'Set the repository and token used to read GitHub work.',
  'auto.githubConfig.workflowTitle': 'Workflow files',
  'auto.githubConfig.workflowDescription': 'Tell the agent how to review pull requests or work on issues.',
  'auto.githubConfig.workflowCreated': 'Created',
  'auto.githubConfig.workflowMissing': 'Not created',
  'auto.githubConfig.createTemplate': 'Create template',
  'auto.githubConfig.openWorkflow': 'Open',
  'auto.githubConfig.replaceTemplate': 'Replace template',
  'auto.githubConfig.workflowEmptyTitle': 'No workflow files yet',
  'auto.githubConfig.workflowEmptyDescription': 'Create at least one template so GitHub automation knows what to do.',
  ...
  'auto.newTask.requireApproval': 'Require review after each run',
...
const MESSAGES_ZH: Record<MessageId, string> = {
  ...
  'skills.pageTitle': '技能',
  'skills.heroTitle': '让 DotCraft 拥有你需要的技能',
  ...
  'auto.githubConfig.subtitle': '连接仓库，并选择 GitHub 自动化要使用的工作流文件。',
  'auto.githubConfig.restartHintShort': '保存后重启 AppServer 生效。',
  'auto.githubConfig.dashboardHintShort': '高级限制、状态和 Hooks 仍在 Dashboard 配置。',
  'auto.githubConfig.statusEnabled': '已启用',
  'auto.githubConfig.statusDisabled': '已停用',
  'auto.githubConfig.connectionTitle': '连接仓库',
  'auto.githubConfig.connectionDescription': '设置读取 GitHub 工作项所需的仓库和 Token。',
  'auto.githubConfig.workflowTitle': '工作流文件',
  'auto.githubConfig.workflowDescription': '告诉智能体如何评审 PR 或处理 Issue。',
  'auto.githubConfig.workflowCreated': '已创建',
  'auto.githubConfig.workflowMissing': '未创建',
  'auto.githubConfig.createTemplate': '创建模板',
  'auto.githubConfig.openWorkflow': '打开',
  'auto.githubConfig.replaceTemplate': '替换模板',
  'auto.githubConfig.workflowEmptyTitle': '还没有工作流文件',
  'auto.githubConfig.workflowEmptyDescription': '至少创建一个模板，GitHub 自动化才知道要做什么。',
  ...
  'auto.newTask.requireApproval': '每次运行后需要审核',
