...
- **Node.js 18+** and **npm**
- **DotCraft AppServer** (`dotcraft` / `dotcraft.exe`) on `PATH` or set in app settings — [Releases](https://github.com/DotCraftDev/DotCraft/releases) or [build from source](../README.md#build-from-source).
