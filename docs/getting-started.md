...
Automations 适合运行本地任务与 GitHub 驱动的工作流。更多调度、审核和重试流程见 [Automations 指南](./automations_guide.md)。

| Desktop 自动化面板 | GitHub 追踪 |
|:---:|:---:|
| ![Desktop 自动化面板](https://github.com/DotHarness/resources/raw/master/dotcraft/desktop_github.png) | ![GitHub 追踪示例](https://github.com/DotHarness/resources/raw/master/dotcraft/github-tracker.png) |
