...
- [windows](https://github.com/DotHarness/dotcraft/tree/master/samples/hooks/windows): Windows / PowerShell 示例
- [linux](https://github.com/DotHarness/dotcraft/tree/master/samples/hooks/linux): Linux / macOS Bash 示例
