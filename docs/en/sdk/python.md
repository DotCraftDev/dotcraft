...
| Example | Description |
|---------|-------------|
| [examples/telegram/](./python-telegram) | Reference Telegram adapter using long polling, inline keyboard approvals, and delivery support. |

## Further Reading

- [ARCHITECTURE.md](https://github.com/DotHarness/dotcraft/blob/master/sdk/python/ARCHITECTURE.md) — How the SDK works internally.
- [specs/external-channel-adapter.md](https://github.com/DotHarness/dotcraft/blob/master/specs/external-channel-adapter.md) — Wire protocol extension spec for channel adapters.
- [specs/appserver-protocol.md](https://github.com/DotHarness/dotcraft/blob/master/specs/appserver-protocol.md) — Full JSON-RPC wire protocol specification.
