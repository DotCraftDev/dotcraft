...
| 示例 | 说明 |
|------|------|
| [examples/telegram/](./python-telegram) | 参考 Telegram 适配器，使用长轮询、内联键盘审批和消息投递支持。 |

## 延伸阅读

- [ARCHITECTURE.md](https://github.com/DotHarness/dotcraft/blob/master/sdk/python/ARCHITECTURE.md) — SDK 内部原理说明。
- [specs/external-channel-adapter.md](https://github.com/DotHarness/dotcraft/blob/master/specs/external-channel-adapter.md) — 渠道适配器 Wire Protocol 扩展规范。
- [specs/appserver-protocol.md](https://github.com/DotHarness/dotcraft/blob/master/specs/appserver-protocol.md) — 完整的 JSON-RPC Wire Protocol 规范。
